...
hashem = open("angerhashtag.txt","r")   
...
for i in range(len(emotions["word"])):
    emotiondic[emotions["word"][i]] = float(emotions["anger"][i])
#print(emotiondic)
...
train = open("anger_train.txt", "r")  # open file 
